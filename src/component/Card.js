...
function Card({ details }) {
    ...
    <div className="col-lg-4">
      <div className="card mb-5 mb-lg-0">
        <div className="card-body">
          ...
          <hr />
          <ul className="fa-ul">
    <li className={details.userEnabler ? "" : "text-muted"}><span className="fa-li"><i className={details.userEnabler?"fas fa-check":"fas fa-times"}></i></span>{details.plan==="Plus"?<b>{details.user}</b>:details.user}</li>
  ...
  <li className={details.publicProjectsEnabler ? "" : "text-muted"}><span className="fa-li"><i className={details.publicProjectsEnabler?"fas fa-check":"fas fa-times"}></i></span>{details.publicProjects}</li>
   ...
   <li className={details.privateProjectsEnabler ? "" : "text-muted"}><span className="fa-li"><i className={details.privateProjectsEnabler?"fas fa-check":"fas fa-times"}></i></span>{details.privateProjects}</li>
    ...
    <li className={details.statusReportEnabler ? "" : "text-muted"}><span className="fa-li"><i className={details.statusReportEnabler?"fas fa-check":"fas fa-times"}></i></span>{details.statusReport}
                    </li>
                  </ul>
